export const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    'settings.manualSync.download': '从得到大脑同步到 Obsidian',
    'settings.manualSync.upload': '从 Obsidian 上传到得到大脑',
  ...
  en: {
    ...
    'settings.communityUrl': 'https://github.com/AndyZhengyan/obsidian-getnote-importer/blob/main/README.md#关于作者',
    'settings.apiToken.label': 'API Token',
