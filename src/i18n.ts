export const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    'settings.credentials.webTip': '临时鉴权使用网页版登录后的 Authorization Bearer Token（可含 Bearer 前缀）。',
    'settings.webTipHelp': '查看 README',
    'settings.webTipHelpUrl': 'https://github.com/AndyZhengyan/obsidian-getnote-importer/blob/main/README_zh.md#web-模式手动-token',
    'settings.authMode.openapi': 'OpenAPI鉴权（会员）',
    'settings.authMode.web': '临时鉴权（Free）',
    'settings.webToken.placeholder': 'Authorization Bearer Token（可含 Bearer 前缀）',
  ...
  en: {
    ...
    'settings.credentials.webTip': 'Temp Auth uses the Authorization Bearer token from an active GetNote web session (Bearer prefix accepted).',
    'settings.webTipHelp': 'View README',
    'settings.webTipHelpUrl': 'https://github.com/AndyZhengyan/obsidian-getnote-importer/blob/main/README.md#web-mode-manual-token',
    'settings.authMode.openapi': 'OpenAPI Auth (PRO)',
    'settings.authMode.web': 'Temp Auth (Free)',
    'settings.webToken.placeholder': 'Authorization Bearer token (Bearer prefix accepted)',
