export const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    'settings.onboarding': '👋 欢迎使用！请先选择认证方式获取凭证，然后点击同步（由于 OpenAPI 限制，目前仅支持 Get笔记PRO 会员）',
  ...
  en: {
    ...
    'settings.onboarding': '👋 Welcome! Please choose an auth method to get credentials, then click sync (OpenAPI is available to GetNotePRO members only).',
