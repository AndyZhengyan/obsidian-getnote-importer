export const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    'settings.scheduled.desc': '开启后按间隔自动同步',
    ...
    'settings.connectionSuccessWithExpiry': '连接成功 · 约 {minutes} 分钟过期',
    'settings.connectionError': '连接失败',
    'settings.connectionErrorMemberHint': '连接失败，OpenAPI 仅对会员开放，可切换到临时鉴权（非会员）',
    'settings.showToken': '显示密钥',
    'settings.hideToken': '隐藏密钥',
    'settings.credentials.tip': '可使用 OAuth 登录获取凭证，或直接粘贴已有 Client ID 和 API Key。',
    'settings.credentials.webTip': '临时鉴权：登录 Get笔记网页版，打开浏览器开发者工具 -> Network -> Fetch/XHR，刷新页面或打开一篇笔记，点开 notes/list 请求，并复制 Request Headers 里的 Authorization 值（可含 Bearer 前缀）。',
    ...
    'settings.authMode.web': '临时鉴权（Free）',
  ...
  en: {
    ...
    'settings.scheduled.desc': 'Automatically sync at regular intervals',
    ...
    'settings.connectionSuccessWithExpiry': 'Connected · expires in ~{minutes} min',
    'settings.connectionError': 'Connection failed',
    'settings.connectionErrorMemberHint': 'Connection failed, OpenAPI is for PRO members. Switch to Temp Auth (Free) instead.',
    ...
    'settings.credentials.webTip': 'Temp Auth: sign in to GetNote Web, open browser DevTools -> Network -> Fetch/XHR, refresh or open a note, choose a notes/list request, then copy the Authorization value from Request Headers (Bearer prefix accepted).',
    ...
    'settings.authMode.web': 'Temp Auth (Free)',
