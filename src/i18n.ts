const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    'settings.syncStartDate.lastSyncedToDesc': '上次同步已处理到的笔记时间，下次自动同步将从此时刻之后开始',
    ...
    'settings.onboarding': '👋 欢迎使用！填写下方 API 凭证后，即可启动同步任务。',
  ...
  en: {
    ...
    'settings.syncStartDate.lastSyncedToDesc': 'Resume point for the next auto sync',
    ...
    'settings.onboarding': '👋 Welcome! Fill in your API credentials below to start syncing notes.',
    ...
    'syncHistory.params.checkpoint': 'Sync checkpoint {date}',
